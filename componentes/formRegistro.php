<section id="formRegistro" style="display:none;" class="comun w-50 container align-center">
            <h2 class="text-center text-light">Registrar</h2>
            <div class="bg-dark text-light rounded-4 p-4">
